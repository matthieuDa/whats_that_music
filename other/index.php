...
<body>
	<div class="padding">
		...
		</br><h6>Choose the project you want to run on the server. Click to open <a href="http://localhost:8888/phpMyAdmin/">phpMyAdmin</a> <!-- or <a href="./devTools.php">developement tools</a>-->.</h6>
